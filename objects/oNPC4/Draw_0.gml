...
if (chat_ui_visible) {
    draw_sprite(ChatUI, 0, x + 2, y - 24); // Draw the sprite slightly above the NPC
}

// Then, draw the dialogue if it's visible
if (dialogue_visible) {
    var dialogue_x = clamp(oPlayer.x - 140, 10, room_width - 300 - 10);  // Adjust and clamp position relative to the player
