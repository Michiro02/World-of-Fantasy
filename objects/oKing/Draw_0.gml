...
if (dialogue_visible) {
     var dialogue_x = clamp(oPlayer.x - 155, 10, room_width - 300 - 10);  // Adjust and clamp position relative to the player
    var dialogue_y = clamp(oPlayer.y - 150, 190, room_height - 180 - 10);  // Adjust and clamp position relative to the player
    var dialogue_width = 305;  // Width of the dialogue box
