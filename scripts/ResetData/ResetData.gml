	...
	giga: 
{
	...
	drops: [
			{ item: global.actionLibrary.potion, chance: 30 }, // 50% chance to drop a potion
			{ item: global.actionLibrary.ether, chance: 20 },  // 30% chance to drop an ether
			{ item: global.actionLibrary.elixir, chance: 10 },
			{ item: global.actionLibrary.revive, chance: 10 },
		],
    AIscript: function() {
        // Randomly select an action from the available actions
        var _action = actions[irandom(array_length(actions) - 1)];
